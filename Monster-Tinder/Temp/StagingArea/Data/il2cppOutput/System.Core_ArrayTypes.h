...
struct LinkU5BU5D_t2902438075  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) Link_t1546507854  m_Items[1];

public:
	inline Link_t1546507854  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Link_t1546507854 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, Link_t1546507854  value)
	{
		m_Items[index] = value;
	}
};
