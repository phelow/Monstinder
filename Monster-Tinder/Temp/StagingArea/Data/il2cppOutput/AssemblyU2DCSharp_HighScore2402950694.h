...
{
public:
	// UnityEngine.UI.Text HighScore::m_text
	Text_t356221433 * ___m_text_2;

public:
	inline static int32_t get_offset_of_m_text_2() { return static_cast<int32_t>(offsetof(HighScore_t2402950694, ___m_text_2)); }
